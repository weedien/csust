					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="27%">序号</td>
								<td align="center" width="27%">分类名称</td>
							...
							<c:forEach var="item" items="${allCategory}">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									    width="18%">${item.cid}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									    width="17%">${item.cname}</td>
									<td align="center" style="HEIGHT: 22px">
										<a
											href="${ pageContext.request.contextPath }/adminCategoryServlet?method=toUpdate&cid=${item.cid}&cname=${item.cname}">
									...
									<td align="center" style="HEIGHT: 22px">
										<a
											href="${ pageContext.request.contextPath }/adminCategoryServlet?method=categoryRemove&cid=${item.cid}">
