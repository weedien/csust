...
<jsp:useBean id="loginUser" scope="request" class="cn.weedien.csust.medium.shop.domain.User"/>
		...
		<ol class="nav nav-tabs">
			...
			<c:if test="${not empty loginUser}">
				...
				<li role="presentation"><a
					href="${pageContext.request.contextPath}/orderServlet?method=findByUid">我的订单</a></li>
				<li role="presentation"><a href="${pageContext.request.contextPath}/userServlet?method=logout">退出</a>
				</li>
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand"
				   href="${pageContext.request.contextPath}/productServlet?method=listAtHome">首页</a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav" id="menu"></ul>
				<form class="navbar-form navbar-right" role="search" id="form1"
				      action="${pageContext.request.contextPath}/productServlet?method=productSearch" method="post">
