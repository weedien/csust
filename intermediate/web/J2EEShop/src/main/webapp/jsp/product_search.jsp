<%@ page import="cn.weedien.util.CookieUtil" %>
<%@ page import="cn.weedien.service.ProductService" %>
<%@ page import="cn.weedien.service.impl.ProductServiceImpl" %>
<%@ page import="cn.weedien.domain.Product" %>
					...
					<nav aria-label="Page navigation">
						<ul class="pagination">
							...
							<c:forEach var="i" begin="1" end="${pageBean.totalPage}">
								...
								<c:if test="${pageBean.pageNumber != i}">
									<li>
										<a href="${pageContext.request.contextPath}/productServlet?method=productList&cid=${pageBean.data[0].cid}&pageNumber=${i}">${i}</a>
									</li>
								</c:if>
							</c:forEach>
