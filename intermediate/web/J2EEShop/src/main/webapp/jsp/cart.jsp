...
<jsp:useBean id="cart" scope="session" class="cn.weedien.domain.Cart"/>
<html>
	<head>
							...
							<tbody>
								...
								<c:forEach items="${cart.cartItems}" var="cartItem">
									<tr class="active">
										...
										<td class="td-width-10">
												<span>
													<a href="${pageContext.request.contextPath }/cartServlet?method=cartAdd&pid=${cartItem.product.pid}&count=1"
														 class="add">添加</a>
												</span>
											<span>
												<a href="${pageContext.request.contextPath }/cartServlet?method=removeItem&pid=${cartItem.product.pid}"
													 class="delete">删除</a>
											</span>
										</td>
									</tr>
