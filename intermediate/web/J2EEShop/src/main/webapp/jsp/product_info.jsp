		...
		<div class="container">
			<div class="row">
				<div
					...
					<a
						href="${pageContext.request.contextPath}/productServlet?method=productList&cid=${product.cid}">${product.cid}</a>&nbsp;&nbsp;&gt;
					<a>${product.pname}</a>
				</div>
				...
				<div style="text-align: center;margin: 0 auto; width: 950px;">
					...
					<div class="col-md-6">
						...
						<div
							...
							<form id="form1" action="${pageContext.request.contextPath}/cartServlet?method=cartAdd"
							      method="post">
